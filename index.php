...
<body id="top">
  ...
  <main>
    <article>
      ...
      <section class="section hero" style="background-image: url('https://assets.myntassets.com/dpr_1.5,q_60,w_400,c_limit,fl_progressive/assets/images/29507574/2024/5/15/12707cf4-e140-45c9-aaa3-077dc15b6bf81715772380505RedTapeMenColourblockedPUSneakers1.jpg')">
        <div class="container">
      ...
      <section class="section collection">
        <div class="container">
          ...
          <ul class="collection-list has-scrollbar">
            ...
            <li>
              <div class="collection-card" style="background-image: url('images/insta-8.jpg')">
            ...
            <li>
              <div class="collection-card" style="background-image: url('images/product-7.jpg')">
          ...
          <ul class="product-list">
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <figure class="card-banner">
                  <img src="images/insta-4.jpg" width="312" height="350" loading="lazy"
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <figure class="card-banner">
                  <img src="images/cta-1.jpg" width="312" height="350" loading="lazy"
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <figure class="card-banner">
                  <img src="images/insta-8.jpg" width="312" height="350" loading="lazy"
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <figure class="card-banner">
                  <img src="images/insta-3.jpg" width="312" height="350" loading="lazy"
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <figure class="card-banner">
                  <img src="images/collection-1.jpg" width="312" height="350" loading="lazy"
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <figure class="card-banner">
                  <img src="images/product-6.jpg" width="312" height="350" loading="lazy"
            ...
            <li class="product-item">
              <div class="product-card" tabindex="0">
                ...
                <figure class="card-banner">
                  <img src="images/product-8.jpg" width="312" height="350" loading="lazy"
                    alt="Simple Fabric Shoe" class="image-contain">
      ...
      <section class="section cta">
        <div class="container">
          ...
          <ul class="cta-list">
            ...
            <li>
              <div class="cta-card" style="background-image: url('images/insta-2.jpg')">
            ...
            <li>
              <div class="cta-card" style="background-image: url('images/product-4.jpg')">
      ...
      <section class="section special">
        <div class="container">
          ...
          <div class="special-banner" style="background-image: url('https://image.made-in-china.com/2f0j00yvpisBodygzj/New-Fashion-Shoes-Men-Breathable-Trend-Men-Style-Brand-Wholesale-Couple-Running-Sports-Fashion-Trending-Sneaker.webp')">
            ...
            <ul class="has-scrollbar">
              ...
              <li class="product-item">
                <div class="product-card" tabindex="0">
                  ...
                  <figure class="card-banner">
                    <img src="images/insta-7.jpg" width="312" height="350" loading="lazy"
                      alt="Running Sneaker Shoes" class="image-contain">
              ...
              <li class="product-item">
                <div class="product-card" tabindex="0">
                  ...
                  <figure class="card-banner">
                    <img src="images/collection-2.jpg" width="312" height="350" loading="lazy"
                      alt="Simple Fabric Shoe" class="image-contain">
      ...
      <section class="section insta-post">
        ...
        <ul class="insta-post-list has-scrollbar">
          ...
          <li class="insta-post-item">
            <img src="images/sponsor-1.png" width="100" height="100" loading="lazy" alt="Instagram post"
          ...
          <li class="insta-post-item">
            <img src="images/sponsor-2.png" width="100" height="100" loading="lazy" alt="Instagram post"
              class="insta-post-banner image-contain">
          ...
          <li class="insta-post-item">
            <img src="images/sponsor-3.png" width="100" height="100" loading="lazy" alt="Instagram post"
              class="insta-post-banner image-contain">
          ...
          <li class="insta-post-item">
            <img src="images/sponsor-4.png" width="100" height="100" loading="lazy" alt="Instagram post"
              class="insta-post-banner image-contain">
          ...
          <li class="insta-post-item">
            <img src="images/sponsor-5.png" width="100" height="100" loading="lazy" alt="Instagram post"
              class="insta-post-banner image-contain">
          ...
          <li class="insta-post-item">
            <img src="images/special-banner.jpg" width="100" height="100" loading="lazy" alt="Instagram post"
              class="insta-post-banner image-contain">
          ...
          <li class="insta-post-item">
            <img src="https://i.pinimg.com/736x/37/aa/8c/37aa8cc16d197b7488ae85f9951367b1.jpg" width="100" height="100" loading="lazy" alt="Instagram post"
              class="insta-post-banner image-contain">
          ...
          <li class="insta-post-item">
            <img src="images/hero-banner.png" width="100" height="100" loading="lazy" alt="Instagram post"
              class="insta-post-banner image-contain">

            <a href="#" class="insta-post-link">
              <ion-icon name="logo-instagram"></ion-icon>
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQHP2W0X8Bj9Wwou8Y5Iv2q_Aa-nME9SMwEAA&s">
            </a>
          </li>
  ...
  <footer class="footer">
          ...
          <ul class="footer-list">
            ...
            <li>
              <address class="footer-link">
                ...
                <span class="footer-link-text">
                  #104, preet nagar near girls govt. college, ambala city, haryana, india 
                </span>
              </address>
            </li>

            <li>
              <a href="tel:+917988964657" class="footer-link">
                <ion-icon name="call"></ion-icon>

                <span class="footer-link-text">+917988964657</span>
              </a>
            </li>
            ...
            <li>
              <a href="mailto:footcap@help.com" class="footer-link">
                ...
                <span class="footer-link-text">rs9854888@gmail.com</span>
              </a>
            </li>
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright">
          &copy; 2022 <a href="#" class="copyright-link">codewithraghav</a>. All Rights Reserved
        </p>
